...
class Opencarp(CMakePackage):
    ...
    version("test-1", commit="1753df4623bac7202498a02156b04e506e6da8de", submodules=False, no_cache=True, preferred=True)
    ...
    for ver in ["test-1", "15.0", "13.0", "12.0", "11.0", "10.0", "9.0", "8.2", "8.1", "7.0"]:
